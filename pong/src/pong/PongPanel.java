...
public class PongPanel extends JPanel implements ActionListener, KeyListener {
	...
	private final static int BALL_MOVEMENT_SPEED = 4;//Changed speed to 4 experiment2
	...
	@Override
	public void keyPressed(KeyEvent event) {//Changed YVelocity to -3 and 3 for faster paddle speed experiment2
